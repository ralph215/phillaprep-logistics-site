export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(15,23,42,0.06),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(59,130,246,0.08),_transparent_24%),linear-gradient(to_bottom,_#f8fafc,_#f5f7fb_38%,_#ffffff_100%)] text-neutral-900">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 md:px-10 lg:px-16">
          <div className="flex items-center gap-4">
            <img
              ...
              className="h-12 w-auto rounded-xl bg-white p-1 ring-1 ring-neutral-200"
            />
            <div>
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,_rgba(255,255,255,0.9),_rgba(248,250,252,0.96)_45%,_rgba(241,245,249,0.95)_100%)] px-6 py-24 md:px-10 lg:px-16">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.98fr_1.02fr] xl:gap-16">
          <div className="max-w-2xl xl:max-w-[40rem]">
            <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/70 bg-white/85 px-4 py-2 shadow-[0_10px_30px_rgba(15,23,42,0.08)] backdrop-blur">
            ...
            <h1 className="max-w-3xl text-5xl font-bold tracking-tight text-neutral-950 [text-wrap:balance] sm:text-6xl lg:text-[4.25rem] lg:leading-[0.97] xl:text-[4.75rem] xl:leading-[0.96]">
              Reliable prep support for Amazon brands
            </h1>

            <p className="mt-6 max-w-lg text-lg leading-8 text-neutral-700 sm:text-xl">
