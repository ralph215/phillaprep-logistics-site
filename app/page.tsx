export default function Home() {
  ...
  <div className="rounded-2xl border border-neutral-200 bg-white/95 px-3 py-3 shadow-sm">
    <div className="flex items-center gap-3">
      <img
        ...
        className="h-10 w-auto shrink-0 rounded-xl bg-white p-1 ring-1 ring-neutral-200"
      />
      <div className="min-w-0">
        <p className="text-[0.78rem] font-bold leading-tight tracking-[0.14em] text-neutral-900">
          PHILAPREP LOGISTICS
        </p>
        <p className="mt-1 text-[0.76rem] leading-snug text-neutral-500">
    ...
    <a
      href="#quote"
      className="mt-3 block w-full rounded-2xl bg-black px-4 py-3.5 text-center text-sm font-medium text-white shadow-[0_12px_24px_rgba(15,23,42,0.16)] transition hover:opacity-90"
    >
      Request a Quote
    </a>
  </div>
              ...
              <img
                src="data:image/webp;base64,"
                alt="PhilaPrep Logistics LLC logo"
                className="h-7 w-auto shrink-0 rounded-lg bg-white p-1 ring-1 ring-neutral-200"
              />
              <div className="min-w-0">
                <p className="text-[0.68rem] font-bold leading-tight tracking-[0.1em] text-neutral-900">
                  PHILAPREP LOGISTICS
                </p>
                <p className="mt-1 text-[0.68rem] leading-snug text-neutral-500">
                  Philadelphia, PA · FBA prep support
                </p>
              </div>
            </div>
          ...
          <div className="mt-3 md:hidden">
            <a
              href="#quote"
              className="block w-full rounded-2xl bg-black px-4 py-3 text-center text-sm font-medium text-white transition hover:opacity-90"
            >
              Request Quote
            </a>
          </div>
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,_rgba(255,255,255,0.9),_rgba(248,250,252,0.96)_45%,_rgba(241,245,249,0.95)_100%)] px-6 py-16 md:px-10 md:py-20 lg:px-16 lg:py-24">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.98fr_1.02fr] xl:gap-16">
          <div className="max-w-2xl xl:max-w-[40rem]">
            ...
            <h1 className="max-w-3xl text-5xl font-bold tracking-tight leading-[0.96] text-neutral-950 [text-wrap:balance] sm:text-6xl lg:text-[4.25rem] lg:leading-[0.97] xl:text-[4.75rem] xl:leading-[0.96]">
              Reliable prep support for Amazon brands
            </h1>

            <p className="mt-5 max-w-lg text-lg leading-8 text-neutral-700 sm:text-xl">
